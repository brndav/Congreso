...
@Component({
  selector: 'app-conferencia-m',
  templateUrl: './conferencia-m.component.html',
  styleUrls: ['./conferencia-m.component.scss'],
})
export class ConferenciaMComponent  implements OnInit {
